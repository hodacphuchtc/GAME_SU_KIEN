...
import { mauChuTrenNen } from "@/lib/vong-quay/mau-chu";
          ...
          return (
            <g key={c.oId}>
              ...
              <text
                ...
                /* 🔴 Màu chữ suy từ ĐỘ CHÓI của chính cung này, không phải một
                   màu chọn sẵn. Trắng trên vàng hay mint chỉ đạt 1,5:1 — vô
                   hình ngay ở 1 mét, chứ đừng nói 3–5 m. Xem lib/vong-quay/mau-chu.ts. */
                fill={mauChuTrenNen(c.mau)}
