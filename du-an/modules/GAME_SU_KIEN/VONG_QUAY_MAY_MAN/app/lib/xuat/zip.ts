/*
 * NGUỒN: chép NGUYÊN VĂN từ `modules/GAME_SU_KIEN/app/lib/xuat/zip.ts` @ 3d96358.
 * ĐÃ SỬA: không sửa gì — bộ dựng ZIP không dính nghiệp vụ của app nào cả.
 * Cấm `import` xuyên hai app (xem quyết định 02/09/2026 ở CLAUDE.md gốc), nên
 * đây là bản chép tay có ghi nguồn.
 */
