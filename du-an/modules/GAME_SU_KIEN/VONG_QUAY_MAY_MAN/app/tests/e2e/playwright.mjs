/*
 * NGUỒN: chép từ `modules/GAME_SU_KIEN/app/tests/e2e/playwright.mjs` @ 3d96358.
 */

/**
 * Nơi DUY NHẤT biết Playwright nằm ở đâu.
 *
 * 🔴 Tách khỏi `chay.mjs` có lý do sống còn: `chay.mjs` chạy cả bộ kịch bản ngay
 * ở tầng cao nhất của module. Kịch bản mà `import` từ nó thì mỗi lần chạy một
 * kịch bản là chạy lại toàn bộ — một vòng lặp không đáy.
 *
