...
/**
 * Ô quà thật còn dưới tỉ lệ này của số lượng ban đầu thì cảnh báo sắp hết.
 *
 * 0,2 = còn 20%, cho quản lý khoảng một ngày để xoay hàng. 🔴 Ngưỡng phải tính
 * `max(1, tỉ_lệ × tổng)`, không thuần tỉ lệ: 20% của 4 là 0,8 mà tồn luôn là
 * số nguyên ≥ 1, nên kho nhỏ nhảy thẳng xanh → biến mất, dải vàng chưa từng bật.
 */
