# OVERVIEW — Module Auth (đăng nhập & phân quyền)

## 1. Mục đích

(1-3 câu: module này giải bài toán gì, cho ai. Cập nhật khi bắt đầu code.)

## 2. Phạm vi (In / Out)

- **In:** (cập nhật khi bắt đầu code.)
- **Out:** (thứ CỐ TÌNH không thuộc module này — và nó thuộc về đâu.)
...
- **Trạng thái (29/08/2026):** vừa khởi tạo khung, chưa code.
