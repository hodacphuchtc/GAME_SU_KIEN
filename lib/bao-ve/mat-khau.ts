 ...
 * nhất cho mật khẩu — kẻ lấy được tệp CSDL sẽ thử hàng tỉ mật khẩu mỗi giây.
 ...
 * ra được từng byte.
 *
 * Trả `false` cho mọi chuỗi hỏng thay vì ném: một bản ghi lỗi định dạng không
 * được phép làm sập cả màn đăng nhập của những người khác.
 */
