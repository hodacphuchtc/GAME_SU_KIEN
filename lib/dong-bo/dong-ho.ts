 ...
 *
 * Vì sao cần: màn hình LCD và điện thoại phải cùng biết "ván bắt đầu lúc nào".
 * Đồng hồ hai máy lệch nhau vài giây là chuyện thường, và độ trễ mạng lại cộng
 * thêm vào. Không canh thì hai bên đếm lệch nhịp thấy rõ.
 *
 ...
 * nhất): một lượt vấp mạng làm sai lệch hẳn con số, mà mạng 4G thì vấp luôn.
 */
